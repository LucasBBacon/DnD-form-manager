Feature: Item Properties and Usage
    ...
    Scenario: Unequipping an Item
        Given the user has a "Shield" in their inventory
    ...
    Scenario: Defining Item Weight and Calculation
        Given the user has 1 "Chain Mail" weighing 55.0 lbs in their inventory
    ...
    Scenario: Defining Damage Dice for a Weapon
        Given the user has a "Greataxe" in their inventory
    ...
    Scenario: Using an object as a generic Improvised Weapon
        Given the user has a "Heavy Tome" in their inventory
    ...
    Scenario: Using an object similar to an actual weapon
        Given the user has a "Table Leg" in their inventory
    ...
    Scenario: Overriding properties on a Custom Named item
        Given the user creates an item "Mithral Chain Shirt" using the "Chain Shirt" template
