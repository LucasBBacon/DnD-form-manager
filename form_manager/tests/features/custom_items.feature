Feature: Custom Item Names and Templates
    ...
    Scenario: Renaming an existing item
        ...
        And the item "Goblin Cleaver" should have a damage die of "1d8" 
    ...
    Scenario: Creating a new item from a Base Template
        ...
        And the item "Sting" should have properties "Light, Finesse"
        And the item "Sting" should have a weight of 2.0 lbs

    Scenario: Overriding properties on a Custom Named item
        Given a new character session is started
        When the user creates an item "Mithral Chain Shirt" using the "Chain Shirt" template
        And the user sets the item weight to 10.0 lbs
        ...
        And the item "Mithral Chain Shirt" should be Category "Medium Armor"